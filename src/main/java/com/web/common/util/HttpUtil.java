...
public class HttpUtil {
	 ...
	 * @return
	 */
	public static Object callURL(String sURL, HashMap<String, String> getData, HashMap<String, String> postData,
			String charSet) {
	 ...
	 * @return
	 */
	public static Object callURLEuckr(String sURL, HashMap<String, String> getData, HashMap<String, String> postData,
			String charSet) {
		HashMap<String, String> hashmapResult = new HashMap<String, String>();
