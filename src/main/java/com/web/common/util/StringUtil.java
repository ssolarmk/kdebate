...
public class StringUtil {
	...
	public static String setAreaNm(String areaCd) {
		...
		if ("2600000000".equals(areaCd))
			areaNm = "부산시";
		else if ("2600000000".equals(areaCd))
			areaNm = "부산시";
		else if ("2700000000".equals(areaCd))
			areaNm = "대구시";
		else if ("2800000000".equals(areaCd))
			areaNm = "인천시";
		else if ("2900000000".equals(areaCd))
			areaNm = "광주시";
		else if ("3000000000".equals(areaCd))
			areaNm = "대전시";
		else if ("3100000000".equals(areaCd))
			areaNm = "울산시";
		else if ("4100000000".equals(areaCd))
			areaNm = "경기도";
		else if ("4200000000".equals(areaCd))
			areaNm = "강원도";
		else if ("4300000000".equals(areaCd))
			areaNm = "충청북도";
		else if ("4400000000".equals(areaCd))
			areaNm = "충청남도";
		else if ("4500000000".equals(areaCd))
			areaNm = "전라북도";
		else if ("4600000000".equals(areaCd))
			areaNm = "전라남도";
		else if ("4700000000".equals(areaCd))
			areaNm = "경상북도";
		else if ("4800000000".equals(areaCd))
			areaNm = "경상남도";
		else if ("5000000000".equals(areaCd))
			areaNm = "제주도";
		return areaNm;
	}
