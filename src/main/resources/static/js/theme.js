...
var getTemplate = function getTemplate(event) {
  return '\n<div class="modal-header bg-body-tertiary ps-card pe-5 border-bottom-0">\n  <div>\n    <h5 class="modal-title mb-0">'
    ...
    .concat(
      event.extendedProps.organizer ? '<p class="mb-0 fs-10 mt-1">\n        by <a href="#!">'.concat(event.extendedProps.organizer, "</a>\n      </p>") : "",
        ...
        tooltip: {
          ...
          formatter: function formatter(params) {
            return '<div class="fw-semibold">'
              .concat(params.seriesName, '</div><div class="fs-10 text-600"><strong>')
...
var locationBySessionInit = function locationBySessionInit() {
  ...
  if ($locationBySessionMap) {
    ...
    (_document$querySelect4 = document.querySelector(".location-by-session-map-zoomOut")) === null ||
